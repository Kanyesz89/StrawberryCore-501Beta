...
enum Opcodes335a
{
    ...
    //EVENT_PET_BATTLE_OPENING_START                 = 0x34D,
    //EVENT_PET_BATTLE_OPENING_DONE                 = 0x34E,
    //EVENT_PET_BATTLE_HEALTH_CHANGED                 = 0x34F,
    //EVENT_PET_BATTLE_TURN_STARTED                 = 0x350,
    //EVENT_PET_BATTLE_PET_CHANGED                     = 0x351,
    //EVENT_PET_BATTLE_FINAL_ROUND                     = 0x352,
    //EVENT_PET_BATTLE_CLOSE                         = 0x353,
    //EVENT_PET_BATTLE_PET_ROUND_RESULTS             = 0x354,
    //EVENT_PET_BATTLE_PET_ROUND_PLAYBACK_COMPLETE  = 0x355,
    //EVENT_PET_BATTLE_ACTION_SELECTED                = 0x356,
